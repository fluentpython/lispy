...
* (code download) [McCarthy's original Lisp](https://sep.yimg.com/ty/cdn/paulgraham/jmc.lisp?t=1595850613) converted to Common Lisp by Paul Graham ([local copy](references/jmc.lisp))
